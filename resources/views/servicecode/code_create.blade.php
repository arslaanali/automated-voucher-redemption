...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                      <div class="card-header"><h4> <b>Add New Service Code </b> </h4></div>

                      <br>

                  <form class="form-horizontal" action="{{ route('servicecode.store') }}" method="post">
                  @csrf
                        <div class="form-group">
                          <label class="control-label col-sm-4">Service Code Name:</label>
                          <div class="col-md-6">
                            <input type="text" class="form-control"  placeholder="Enter name" name="service_code" required>
                          </div>
                        </div>
